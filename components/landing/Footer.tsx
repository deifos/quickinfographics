...
export function Footer() {
  return (
    <footer className="border-border/50 border-t px-5 py-8 sm:px-8 lg:px-20">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 sm:flex-row">
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/changelog"
            className="bg-muted text-muted-foreground hover:text-foreground rounded-full px-2.5 py-0.5 text-xs font-medium transition-colors"
          >
            v1.2.0
          </Link>
          <span className="text-muted-foreground/40">·</span>
          <a
            href="https://github.com/deifos/quickinfographics"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-foreground transition-colors"
          >
